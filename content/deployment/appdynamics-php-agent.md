...
5. Execute find / -name appdynamics_agent.ini to get the installed
    ...
    would be the base location of the php application installed on the
    server.
...
7. Navigate to php agent installed location, in our case it was
    /usr/lib/appdynamics-php-agent.
